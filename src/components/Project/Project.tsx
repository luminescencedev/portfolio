const Project = () => {
  ...
  return (
    <>
      <main className=" relative h-screen w-screen overflow-hidden bg-zinc-100 touch-none lg:touch-auto">
        ...
        <div className="img-preview absolute top-[45%] lg:top-1/2 left-1/2 -translate-1/2 w-3/4 lg:w-1/2 h-1/2 lg:h-3/4 overflow-hidden ">
          <img
            className="absolute top-1/2 left-1/2 -translate-1/2 w-full h-full object-fit contain;"
            src="/Gradient/Gradient1.jpg"
            alt=""
          />
        </div>

        <div className="absolute top-auto lg:top-1/2 right-auto lg:right-[8em] bottom-[8em] lg:bottom-auto left-1/2 lg:left-auto h-20 lg:h-auto w-auto lg:w-20 touch-none lg:touch-auto">
          <div className="indicator absolute top-0 left-0 h-full lg:h-16 w-16 lg:w-full border z-2"></div>
          <div className="items relative w-max lg:w-full h-full flex flex-row lg:flex-col gap-0 will-change-transform touche-none lg:touch-auto">
            {[...Array(17)].map((_, i) => (
              <div
                className="item w-16 lg:w-full h-full lg:h-16 p-1.5 cursor-pointer"
                key={i}
              >
                <img src={`/Gradient/Gradient${i + 1}.jpg`} alt="" />
              </div>
            ))}
          </div>
        </div>
